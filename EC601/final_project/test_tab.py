...
def parse_args():
    ...
    parser.add_argument('--config', default='./configs/pointpillars/pointpillars_hv_secfpn_8xb6-160e_kitti-3d-3class.py', help='test config file path')
    parser.add_argument('--checkpoint', default='./checkpoints/hv_pointpillars_secfpn_6x8_160e_kitti-3d-3class_20220301_150306-37dc2420.pth', help='checkpoint file')
    parser.add_argument(
        '--work-dir', default='./output/test/',
...
def test_main(model_path, checkpoint_path):
    args = parse_args()

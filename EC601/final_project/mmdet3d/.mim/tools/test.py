...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/point_rcnn/point-rcnn_8xb2_kitti-3d-3class.py', help='test config file path')
    parser.add_argument('--checkpoint', default='configs/point_rcnn/point_rcnn_2x8_kitti-3d-3classes_20211208_151344.pth', help='checkpoint file')
    parser.add_argument(
        '--work-dir',
